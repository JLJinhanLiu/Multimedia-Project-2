...
public class WaveFormService extends Service<Boolean> {
	...
	private static float[] resultingWaveform, waveData;
	...
	protected Task<Boolean> createTask() {
		return new Task<Boolean>() {
			 ...
			 * @throws IOException
			 */
			public int[] getWavAmplitudes(File file) throws UnsupportedAudioFileException , IOException {
	...
	public static float[] getResultingWaveform() {
		return waveData;
	}
